...
documentation: /posts/portfolio/portfolio-hub
featured: true
draft: false
order: 1
...
Pages estáticas em `src/pages/`. Conteúdo dinâmico via `src/pages/posts/[...slug].astro`, que mapeia todas as collections para URLs `/posts/{collection}/{slug}`.
